...
# Hierarchical cell: StreamingFIFO_3
proc create_hier_cell_StreamingFIFO_3 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_StreamingFIFO_3() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_StreamingFCLayer_Batch_8 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_8_pvo29c3l/} \
   CONFIG.MEM_WIDTH {32} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_7 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_7_ootgkz5t/} \
   CONFIG.MEM_WIDTH {16} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_6 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {65536} \
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_6_jr0t8kfb/} \
   CONFIG.MEM_WIDTH {8} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {distributed} \
   CONFIG.STRM0_DEPTH {65536} \
...
proc create_hier_cell_StreamingFCLayer_Batch_5 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_5__n07md24/} \
   CONFIG.MEM_WIDTH {16} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_4 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_4_47bak59j/} \
   CONFIG.MEM_WIDTH {32} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
...
proc create_hier_cell_StreamingFCLayer_Batch_3 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_3_ez_7u1o9/} \
   CONFIG.MEM_WIDTH {32} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {block} \
...
proc create_hier_cell_StreamingFCLayer_Batch_2 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {18432} \
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_2_bq15lqe6/} \
   CONFIG.MEM_WIDTH {16} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {18432} \
...
proc create_hier_cell_StreamingFCLayer_Batch_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_1_nfezrczu/} \
   CONFIG.MEM_WIDTH {16} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
...
proc create_hier_cell_StreamingFCLayer_Batch_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_0__usd14fq/} \
   CONFIG.MEM_WIDTH {8} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
...
proc create_root_design { parentCell } {
  ...
  create_hier_cell_StreamingFIFO_2 [current_bd_instance .] StreamingFIFO_2

  # Create instance: StreamingFIFO_3
  create_hier_cell_StreamingFIFO_3 [current_bd_instance .] StreamingFIFO_3

  # Create instance: StreamingFIFO_4
  create_hier_cell_StreamingFIFO_4 [current_bd_instance .] StreamingFIFO_4
  ...
  create_hier_cell_StreamingFIFO_12 [current_bd_instance .] StreamingFIFO_12

  # Create instance: StreamingFIFO_17
  create_hier_cell_StreamingFIFO_17 [current_bd_instance .] StreamingFIFO_17
  ...
  connect_bd_intf_net -intf_net ConvolutionInputGenerator_5_out_V_V [get_bd_intf_pins ConvolutionInputGenerator_5/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_5/in0_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_2_out_V_V [get_bd_intf_pins ConvolutionInputGenerator_3/in0_V_V] [get_bd_intf_pins StreamingDataWidthConverter_Batch_2/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_4_out_V_V [get_bd_intf_pins ConvolutionInputGenerator_4/in0_V_V] [get_bd_intf_pins StreamingDataWidthConverter_Batch_4/out_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_5_out_V_V [get_bd_intf_pins ConvolutionInputGenerator_5/in0_V_V] [get_bd_intf_pins StreamingDataWidthConverter_Batch_5/out_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_6_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_6/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_6/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_7_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_7/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_7/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_8_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_8/out_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_8/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_9_out_V_V [get_bd_intf_pins LabelSelect_Batch_0/in0_V_V] [get_bd_intf_pins StreamingDataWidthConverter_Batch_9/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_1_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_0/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_1/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_3_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_3/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_3/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_5_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_6/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_5/out_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_6_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_7/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_6/out_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_7_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_8/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_7/out_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_8_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_9/in0_V_V] [get_bd_intf_pins StreamingFCLayer_Batch_8/out_V_V]
