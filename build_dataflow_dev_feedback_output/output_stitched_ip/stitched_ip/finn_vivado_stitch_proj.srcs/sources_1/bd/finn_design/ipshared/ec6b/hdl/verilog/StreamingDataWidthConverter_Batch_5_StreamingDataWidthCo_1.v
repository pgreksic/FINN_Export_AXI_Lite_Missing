...
reg   [0:0] icmp_ln517_reg_154;
reg   [7:0] r_V_reg_61;
reg   [10:0] t_0_reg_72;
reg   [0:0] icmp_ln508_reg_135;
reg    ap_block_state2_pp0_stage0_iter0;
wire    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_state3_io;
reg    ap_block_pp0_stage0_11001;
wire   [10:0] t_fu_94_p2;
reg   [7:0] tmp_V_reg_144;
wire   [15:0] p_Result_s_fu_103_p3;
reg   [15:0] p_Result_s_reg_149;
wire   [0:0] icmp_ln517_fu_117_p2;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [7:0] ap_phi_mux_r_V_phi_fu_65_p4;
reg   [31:0] i_1_fu_44;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln517_fu_117_p2 == 1'd0) & (icmp_ln508_fu_88_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_1_fu_44 <= i_fu_111_p2;
    end else if ((((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln517_fu_117_p2 == 1'd1) & (icmp_ln508_fu_88_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1)))) begin
        i_1_fu_44 <= 32'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln508_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln508_reg_135 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln517_reg_154 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln517_reg_154 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        out_V_V_TVALID = 1'b1;
    end else begin
        out_V_V_TVALID = 1'b0;
    end
...
always @ (*) begin
    ap_block_state3_io = ((icmp_ln517_reg_154 == 1'd1) & (out_V_V_TREADY == 1'b0));
end
...
assign icmp_ln508_fu_88_p2 = ((t_0_reg_72 == 11'd1152) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_117_p2 = ((i_fu_111_p2 == 32'd2) ? 1'b1 : 1'b0);

assign out_V_V_TDATA = p_Result_s_reg_149;

assign p_Result_s_fu_103_p3 = {{in_V_V_TDATA}, {ap_phi_mux_r_V_phi_fu_65_p4}};

assign t_fu_94_p2 = (t_0_reg_72 + 11'd1);
