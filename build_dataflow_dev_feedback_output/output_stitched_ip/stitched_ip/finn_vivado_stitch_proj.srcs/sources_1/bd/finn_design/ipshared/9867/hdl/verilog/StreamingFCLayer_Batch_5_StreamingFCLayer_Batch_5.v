...
reg weights_V_V_TREADY;
 ...
 reg    ap_rst_n_inv;
wire    grp_Matrix_Vector_Activa_fu_56_ap_start;
wire    grp_Matrix_Vector_Activa_fu_56_ap_done;
wire    grp_Matrix_Vector_Activa_fu_56_ap_idle;
wire    grp_Matrix_Vector_Activa_fu_56_ap_ready;
wire    grp_Matrix_Vector_Activa_fu_56_in_V_V_TREADY;
wire   [7:0] grp_Matrix_Vector_Activa_fu_56_out_V_V_TDATA;
wire    grp_Matrix_Vector_Activa_fu_56_out_V_V_TVALID;
wire    grp_Matrix_Vector_Activa_fu_56_out_V_V_TREADY;
wire    grp_Matrix_Vector_Activa_fu_56_weight_V_V_TREADY;
reg    grp_Matrix_Vector_Activa_fu_56_ap_start_reg;
...
initial begin
#0 grp_Matrix_Vector_Activa_fu_56_ap_start_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
end

StreamingFCLayer_Batch_5_Matrix_Vector_Activa grp_Matrix_Vector_Activa_fu_56(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_Matrix_Vector_Activa_fu_56_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_Matrix_Vector_Activa_fu_56_ap_start_reg <= 1'b1;
        end else if ((grp_Matrix_Vector_Activa_fu_56_ap_ready == 1'b1)) begin
            grp_Matrix_Vector_Activa_fu_56_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_Matrix_Vector_Activa_fu_56_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_Matrix_Vector_Activa_fu_56_ap_start = grp_Matrix_Vector_Activa_fu_56_ap_start_reg;

assign grp_Matrix_Vector_Activa_fu_56_out_V_V_TREADY = (out_V_V_TREADY_int & ap_CS_fsm_state3);
