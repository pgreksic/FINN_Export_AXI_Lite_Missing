...
(* CORE_GENERATION_INFO="StreamingFCLayer_Batch_7_StreamingFCLayer_Batch_7,hls_ip_2020_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.731000,HLS_SYN_LAT=65543,HLS_SYN_TPT=none,HLS_SYN_MEM=28,HLS_SYN_DSP=0,HLS_SYN_FF=2308,HLS_SYN_LUT=2662,HLS_VERSION=2020_1_1}" *)

module StreamingFCLayer_Batch_7_StreamingFCLayer_Batch_7 (
        ap_clk,
        ap_rst_n,
        in0_V_V_TDATA,
        in0_V_V_TVALID,
...
reg weights_V_V_TREADY;
 ...
 reg    ap_rst_n_inv;
wire    grp_Matrix_Vector_Activa_fu_84_ap_start;
wire    grp_Matrix_Vector_Activa_fu_84_ap_done;
wire    grp_Matrix_Vector_Activa_fu_84_ap_idle;
wire    grp_Matrix_Vector_Activa_fu_84_ap_ready;
wire    grp_Matrix_Vector_Activa_fu_84_in_V_V_TREADY;
wire   [7:0] grp_Matrix_Vector_Activa_fu_84_out_V_V_TDATA;
wire    grp_Matrix_Vector_Activa_fu_84_out_V_V_TVALID;
wire    grp_Matrix_Vector_Activa_fu_84_out_V_V_TREADY;
wire    grp_Matrix_Vector_Activa_fu_84_weight_V_V_TREADY;
reg    grp_Matrix_Vector_Activa_fu_84_ap_start_reg;
...
initial begin
#0 grp_Matrix_Vector_Activa_fu_84_ap_start_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_Matrix_Vector_Activa_fu_84_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_Matrix_Vector_Activa_fu_84_ap_start_reg <= 1'b1;
        end else if ((grp_Matrix_Vector_Activa_fu_84_ap_ready == 1'b1)) begin
            grp_Matrix_Vector_Activa_fu_84_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_Matrix_Vector_Activa_fu_84_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_Matrix_Vector_Activa_fu_84_ap_start = grp_Matrix_Vector_Activa_fu_84_ap_start_reg;

assign grp_Matrix_Vector_Activa_fu_84_out_V_V_TREADY = (out_V_V_TREADY_int & ap_CS_fsm_state3);

assign out_V_V_TVALID = regslice_both_out_V_V_U_vld_out;

endmodule //StreamingFCLayer_Batch_7_StreamingFCLayer_Batch_7
