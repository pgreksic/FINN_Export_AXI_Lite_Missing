...
proc create_hier_cell_StreamingFCLayer_Batch_6 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_6_emgw76in/} \
   CONFIG.MEM_WIDTH {8} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_4 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_4_r20yx0xx/} \
...
proc create_hier_cell_StreamingFCLayer_Batch_2 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_3_svfl8kgq/} \
   CONFIG.MEM_WIDTH {128} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingFCLayer_Batch_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_1_0qzig8el/} \
   CONFIG.MEM_WIDTH {64} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
...
proc create_hier_cell_StreamingFCLayer_Batch_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_INIT {/home/grgov/Diplomski_rad/finn_modified_docker_output_dir/code_gen_ipgen_StreamingFCLayer_Batch_0_wkar_7k5/} \
   CONFIG.MEM_WIDTH {32} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ConvolutionInputGenerator_1_out_V_V [get_bd_intf_pins ConvolutionInputGenerator_1/out_V_V] [get_bd_intf_pins StreamingFIFO_2/in0_V_V]
  ...
  connect_bd_intf_net -intf_net LabelSelect_Batch_0_out_V_V [get_bd_intf_pins LabelSelect_Batch_0/out_V_V] [get_bd_intf_pins StreamingFIFO_19/in0_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_1_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_1/out_V_V] [get_bd_intf_pins StreamingFIFO_7/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_2_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_2/out_V_V] [get_bd_intf_pins StreamingFIFO_8/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_3_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_3/out_V_V] [get_bd_intf_pins StreamingFIFO_12/in0_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingDataWidthConverter_Batch_5_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_5/out_V_V] [get_bd_intf_pins StreamingFIFO_16/in0_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_0_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_0/out_V_V] [get_bd_intf_pins StreamingFIFO_4/in0_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_3_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_3/out_V_V] [get_bd_intf_pins StreamingFIFO_11/in0_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_4_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_4/out_V_V] [get_bd_intf_pins StreamingFIFO_14/in0_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_5_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_5/out_V_V] [get_bd_intf_pins StreamingFIFO_17/in0_V_V]
  connect_bd_intf_net -intf_net StreamingFCLayer_Batch_6_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_6/out_V_V] [get_bd_intf_pins StreamingFIFO_18/in0_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFIFO_10_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_3/in0_V_V] [get_bd_intf_pins StreamingFIFO_10/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_11_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_4/in0_V_V] [get_bd_intf_pins StreamingFIFO_11/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_12_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_4/in0_V_V] [get_bd_intf_pins StreamingFIFO_12/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFIFO_14_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_5/in0_V_V] [get_bd_intf_pins StreamingFIFO_14/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFIFO_16_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_6/in0_V_V] [get_bd_intf_pins StreamingFIFO_16/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_17_out_V_V [get_bd_intf_pins StreamingFIFO_17/out_V_V] [get_bd_intf_pins Thresholding_Batch_2/in0_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_18_out_V_V [get_bd_intf_pins LabelSelect_Batch_0/in0_V_V] [get_bd_intf_pins StreamingFIFO_18/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_19_out_V_V [get_bd_intf_ports m_axis_2] [get_bd_intf_pins StreamingFIFO_19/out_V_V]
  ...
  connect_bd_intf_net -intf_net StreamingFIFO_2_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_1/in0_V_V] [get_bd_intf_pins StreamingFIFO_2/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_3_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_0/in0_V_V] [get_bd_intf_pins StreamingFIFO_3/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_4_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_1/in0_V_V] [get_bd_intf_pins StreamingFIFO_4/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_5_out_V_V [get_bd_intf_pins StreamingDataWidthConverter_Batch_2/in0_V_V] [get_bd_intf_pins StreamingFIFO_5/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_6_out_V_V [get_bd_intf_pins ConvolutionInputGenerator_2/in0_V_V] [get_bd_intf_pins StreamingFIFO_6/out_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_7_out_V_V [get_bd_intf_pins StreamingFIFO_7/out_V_V] [get_bd_intf_pins Thresholding_Batch_1/in0_V_V]
  connect_bd_intf_net -intf_net StreamingFIFO_8_out_V_V [get_bd_intf_pins StreamingFCLayer_Batch_2/in0_V_V] [get_bd_intf_pins StreamingFIFO_8/out_V_V]
  ...
  connect_bd_intf_net -intf_net Thresholding_Batch_0_out_V_V [get_bd_intf_pins StreamingFIFO_3/in0_V_V] [get_bd_intf_pins Thresholding_Batch_0/out_V_V]
