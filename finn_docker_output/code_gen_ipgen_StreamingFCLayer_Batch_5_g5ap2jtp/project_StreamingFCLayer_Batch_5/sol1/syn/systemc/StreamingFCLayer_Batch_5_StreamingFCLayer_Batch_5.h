...
struct StreamingFCLayer_Batch_5_StreamingFCLayer_Batch_5 : public sc_module {
    ...
    StreamingFCLayer_Batch_5_regslice_both<32>* regslice_both_in0_V_V_U;
    StreamingFCLayer_Batch_5_regslice_both<32>* regslice_both_weights_V_V_U;
    StreamingFCLayer_Batch_5_regslice_both<16>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<16> > grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA;
