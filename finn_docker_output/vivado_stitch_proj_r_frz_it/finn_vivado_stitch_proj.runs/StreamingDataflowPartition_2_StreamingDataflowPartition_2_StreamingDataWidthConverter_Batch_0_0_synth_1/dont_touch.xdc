...
# IP: The module: 'StreamingDataflowPartition_2_StreamingDataflowPartition_2_StreamingDataWidthConverter_Batch_0_0' is the root of the design. Do not add the DONT_TOUCH constraint.
...
# XDC: The top module name and the constraint reference have the same name: 'StreamingDataflowPartition_2_StreamingDataflowPartition_2_StreamingDataWidthConverter_Batch_0_0'. Do not add the DONT_TOUCH constraint.
