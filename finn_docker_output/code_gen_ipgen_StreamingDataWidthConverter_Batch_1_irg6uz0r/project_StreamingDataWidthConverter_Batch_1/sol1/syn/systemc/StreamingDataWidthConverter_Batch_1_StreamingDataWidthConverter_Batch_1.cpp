...
StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1::StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    regslice_both_in0_V_V_U = new StreamingDataWidthConverter_Batch_1_regslice_both<96>("regslice_both_in0_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingDataWidthConverter_Batch_1_regslice_both<24>("regslice_both_out_V_V_U");
