...
set C_modelArgList {
	{ in_V_V int 96 regular {axi_s 0 volatile  { in_V_V Data } }  }
	{ out_V_V int 24 regular {axi_s 1 volatile  { out_V_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V_V", "interface" : "axis", "bitwidth" : 96, "direction" : "READONLY"} , 
 	{ "Name" : "out_V_V", "interface" : "axis", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_V_V_TDATA sc_in sc_lv 96 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":96, "type": "signal", "bundle":{"name": "in_V_V", "role": "TDATA" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "12802", "Max" : "12802"}
	, {"Name" : "Interval", "Min" : "12802", "Max" : "12802"}
]}
...
set Spec2ImplPortList { 
	in_V_V { axis {  { in_V_V_TDATA in_data 0 96 }  { in_V_V_TVALID in_vld 0 1 }  { in_V_V_TREADY in_acc 1 1 } } }
