...
entity LabelSelect_Batch_0_LabelSelect_Batch_0 is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of LabelSelect_Batch_0_LabelSelect_Batch_0 is 
    ...
    signal grp_LabelSelect_Batch_fu_26_ap_start : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_ap_done : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_ap_idle : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_ap_ready : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_in_V_V_TREADY : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_out_V_V_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_LabelSelect_Batch_fu_26_out_V_V_TVALID : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_out_V_V_TREADY : STD_LOGIC;
    signal grp_LabelSelect_Batch_fu_26_ap_start_reg : STD_LOGIC := '0';
    ...
    component LabelSelect_Batch_0_LabelSelect_Batch IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_LabelSelect_Batch_fu_26 : component LabelSelect_Batch_0_LabelSelect_Batch
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_LabelSelect_Batch_fu_26_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((grp_LabelSelect_Batch_fu_26_ap_ready = ap_const_logic_1)) then 
                    grp_LabelSelect_Batch_fu_26_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (grp_LabelSelect_Batch_fu_26_ap_done, ap_CS_fsm, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_out_V_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_LabelSelect_Batch_fu_26_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_LabelSelect_Batch_fu_26_ap_start <= grp_LabelSelect_Batch_fu_26_ap_start_reg;
    grp_LabelSelect_Batch_fu_26_out_V_V_TREADY <= (out_V_V_TREADY_int and ap_CS_fsm_state3);
    ...
    in0_V_V_TREADY_int_assign_proc : process(grp_LabelSelect_Batch_fu_26_in_V_V_TREADY, ap_CS_fsm_state3)
    begin
