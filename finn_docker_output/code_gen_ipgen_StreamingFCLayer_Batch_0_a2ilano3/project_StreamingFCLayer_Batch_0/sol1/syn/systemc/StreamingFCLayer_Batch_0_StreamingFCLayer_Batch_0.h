...
struct StreamingFCLayer_Batch_0_StreamingFCLayer_Batch_0 : public sc_module {
    ...
    StreamingFCLayer_Batch_0_regslice_both<32>* regslice_both_weights_V_V_U;
    StreamingFCLayer_Batch_0_regslice_both<96>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<96> > grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA;
