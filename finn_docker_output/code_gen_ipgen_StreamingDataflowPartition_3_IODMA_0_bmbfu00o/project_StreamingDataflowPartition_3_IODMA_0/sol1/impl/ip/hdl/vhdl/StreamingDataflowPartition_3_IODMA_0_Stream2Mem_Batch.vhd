...
entity StreamingDataflowPartition_3_IODMA_0_Stream2Mem_Batch is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of StreamingDataflowPartition_3_IODMA_0_Stream2Mem_Batch is 
    ...
    component StreamingDataflowPartition_3_IODMA_0_Stream2Mem_8u_16u_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component StreamingDataflowPartition_3_IODMA_0_Stream2Mem_8u_1u_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_Stream2Mem_8u_16u_s_fu_54 : component StreamingDataflowPartition_3_IODMA_0_Stream2Mem_8u_16u_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_Stream2Mem_8u_1u_s_fu_64 : component StreamingDataflowPartition_3_IODMA_0_Stream2Mem_8u_1u_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
