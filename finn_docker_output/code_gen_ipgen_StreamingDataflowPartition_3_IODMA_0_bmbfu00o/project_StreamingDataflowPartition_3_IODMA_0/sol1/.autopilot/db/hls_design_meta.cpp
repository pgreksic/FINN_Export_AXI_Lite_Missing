...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in0_V_V_TDATA", 8, hls_in, 1, "axis", "in_data", 1),
	Port_Property("in0_V_V_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("in0_V_V_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
};
const char* HLS_Design_Meta::dut_name = "StreamingDataflowPartition_3_IODMA_0";
