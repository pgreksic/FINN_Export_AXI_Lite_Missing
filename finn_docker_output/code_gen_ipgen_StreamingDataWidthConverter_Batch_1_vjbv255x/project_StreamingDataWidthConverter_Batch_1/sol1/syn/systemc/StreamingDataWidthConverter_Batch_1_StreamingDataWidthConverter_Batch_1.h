...
#ifndef _StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1_HH_
#define _StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1_HH_
...
struct StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    sc_in< sc_logic > ap_rst_n;
    sc_in< sc_lv<96> > in0_V_V_TDATA;
    ...
    // Module declarations
    StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1(sc_module_name name);
    SC_HAS_PROCESS(StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1);
    ...
    StreamingDataWidthConverter_Batch_1_regslice_both<96>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_1_regslice_both<24>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<24> > grp_StreamingDataWidthCo_1_fu_26_out_V_V_TDATA;
    ...
    sc_signal< sc_lv<96> > in0_V_V_TDATA_int;
