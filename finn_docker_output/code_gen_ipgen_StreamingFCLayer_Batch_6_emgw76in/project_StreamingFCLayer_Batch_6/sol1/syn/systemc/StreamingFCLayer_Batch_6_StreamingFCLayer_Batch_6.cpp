...
StreamingFCLayer_Batch_6_StreamingFCLayer_Batch_6::StreamingFCLayer_Batch_6_StreamingFCLayer_Batch_6(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Matrix_Vector_Activa_fu_28 = new StreamingFCLayer_Batch_6_Matrix_Vector_Activa("grp_Matrix_Vector_Activa_fu_28");
    ...
    regslice_both_out_V_V_U = new StreamingFCLayer_Batch_6_regslice_both<16>("regslice_both_out_V_V_U");
...
void StreamingFCLayer_Batch_6_StreamingFCLayer_Batch_6::thread_grp_Matrix_Vector_Activa_fu_28_ap_start() {
    grp_Matrix_Vector_Activa_fu_28_ap_start = grp_Matrix_Vector_Activa_fu_28_ap_start_reg.read();
}

void StreamingFCLayer_Batch_6_StreamingFCLayer_Batch_6::thread_grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY() {
