...
#ifndef _ConvolutionInputGenerator_3_ConvolutionInputGenerator_3_HH_
#define _ConvolutionInputGenerator_3_ConvolutionInputGenerator_3_HH_
...
struct ConvolutionInputGenerator_3_ConvolutionInputGenerator_3 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    ConvolutionInputGenerator_3_ConvolutionInputGenerator_3(sc_module_name name);
    SC_HAS_PROCESS(ConvolutionInputGenerator_3_ConvolutionInputGenerator_3);
    ...
    ConvolutionInputGenerator_3_regslice_both<32>* regslice_both_in0_V_V_U;
    ConvolutionInputGenerator_3_regslice_both<32>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<32> > grp_ConvolutionInputGene_1_fu_26_out_V_V_TDATA;
