...
//Command     : generate_target StreamingDataflowPartition_3_wrapper.bd
//Design      : StreamingDataflowPartition_3_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module StreamingDataflowPartition_3_wrapper
   (ap_clk,
    ap_rst_n,
    m_axi_gmem0_araddr,
    m_axi_gmem0_arburst,
  ...
  StreamingDataflowPartition_3 StreamingDataflowPartition_3_i
       (.ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
