...
struct StreamingDataWidthConverter_Batch_4_StreamingDataWidthConverter_Batch_4 : public sc_module {
    ...
    StreamingDataWidthConverter_Batch_4_regslice_both<16>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_4_regslice_both<32>* regslice_both_out_V_V_U;
