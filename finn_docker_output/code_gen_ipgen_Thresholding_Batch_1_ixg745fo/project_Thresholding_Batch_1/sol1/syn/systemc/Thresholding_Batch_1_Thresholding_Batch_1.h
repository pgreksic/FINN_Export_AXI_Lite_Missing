...
#ifndef _Thresholding_Batch_1_Thresholding_Batch_1_HH_
#define _Thresholding_Batch_1_Thresholding_Batch_1_HH_
...
struct Thresholding_Batch_1_Thresholding_Batch_1 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    Thresholding_Batch_1_Thresholding_Batch_1(sc_module_name name);
    SC_HAS_PROCESS(Thresholding_Batch_1_Thresholding_Batch_1);

    ~Thresholding_Batch_1_Thresholding_Batch_1();
    ...
    Thresholding_Batch_1_regslice_both<24>* regslice_both_in0_V_V_U;
    Thresholding_Batch_1_regslice_both<8>* regslice_both_out_V_V_U;
