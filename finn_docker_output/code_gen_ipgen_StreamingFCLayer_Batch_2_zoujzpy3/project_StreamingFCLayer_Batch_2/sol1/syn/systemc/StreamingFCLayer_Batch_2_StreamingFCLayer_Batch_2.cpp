...
StreamingFCLayer_Batch_2_StreamingFCLayer_Batch_2::StreamingFCLayer_Batch_2_StreamingFCLayer_Batch_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Matrix_Vector_Activa_fu_140 = new StreamingFCLayer_Batch_2_Matrix_Vector_Activa("grp_Matrix_Vector_Activa_fu_140");
    ...
    regslice_both_in0_V_V_U = new StreamingFCLayer_Batch_2_regslice_both<24>("regslice_both_in0_V_V_U");
    ...
    regslice_both_weights_V_V_U = new StreamingFCLayer_Batch_2_regslice_both<48>("regslice_both_weights_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingFCLayer_Batch_2_regslice_both<16>("regslice_both_out_V_V_U");
...
void StreamingFCLayer_Batch_2_StreamingFCLayer_Batch_2::thread_grp_Matrix_Vector_Activa_fu_140_ap_start() {
    grp_Matrix_Vector_Activa_fu_140_ap_start = grp_Matrix_Vector_Activa_fu_140_ap_start_reg.read();
}

void StreamingFCLayer_Batch_2_StreamingFCLayer_Batch_2::thread_grp_Matrix_Vector_Activa_fu_140_out_V_V_TREADY() {
