...
struct StreamingDataWidthConverter_Batch_3_StreamingDataWidthConverter_Batch_3 : public sc_module {
    ...
    StreamingDataWidthConverter_Batch_3_regslice_both<16>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_3_regslice_both<32>* regslice_both_out_V_V_U;
