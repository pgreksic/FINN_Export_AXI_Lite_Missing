...
StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    regslice_both_in0_V_V_U = new StreamingDataWidthConverter_Batch_5_regslice_both<16>("regslice_both_in0_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingDataWidthConverter_Batch_5_regslice_both<8>("regslice_both_out_V_V_U");
