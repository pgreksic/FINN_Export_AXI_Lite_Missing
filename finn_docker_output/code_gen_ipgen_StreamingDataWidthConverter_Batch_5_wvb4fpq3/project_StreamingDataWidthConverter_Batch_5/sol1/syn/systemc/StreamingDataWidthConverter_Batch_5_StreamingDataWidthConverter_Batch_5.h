...
struct StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5 : public sc_module {
    ...
    StreamingDataWidthConverter_Batch_5_regslice_both<16>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_5_regslice_both<8>* regslice_both_out_V_V_U;
