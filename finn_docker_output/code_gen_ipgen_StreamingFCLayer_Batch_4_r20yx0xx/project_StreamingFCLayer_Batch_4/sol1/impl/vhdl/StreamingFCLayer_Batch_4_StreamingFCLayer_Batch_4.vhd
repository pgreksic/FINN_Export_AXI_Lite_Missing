...
entity StreamingFCLayer_Batch_4_StreamingFCLayer_Batch_4 is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of StreamingFCLayer_Batch_4_StreamingFCLayer_Batch_4 is 
    ...
    component StreamingFCLayer_Batch_4_Matrix_Vector_Activa IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_Matrix_Vector_Activa_fu_140 : component StreamingFCLayer_Batch_4_Matrix_Vector_Activa
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
