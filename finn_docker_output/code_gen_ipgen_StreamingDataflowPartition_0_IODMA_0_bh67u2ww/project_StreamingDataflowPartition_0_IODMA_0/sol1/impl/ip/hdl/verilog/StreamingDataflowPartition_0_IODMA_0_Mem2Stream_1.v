...
reg   [0:0] icmp_ln140_reg_135;
reg    out_V_V_TDATA_blk_n;
reg   [11:0] i_0_reg_90;
reg   [63:0] in_V_addr_reg_129;
wire   [0:0] icmp_ln140_fu_117_p2;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
reg    ap_block_state10_io;
reg    ap_block_pp0_stage0_11001;
wire   [11:0] i_fu_123_p2;
reg    ap_enable_reg_pp0_iter0;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
wire   [63:0] add_ln142_fu_105_p2;
reg    ap_block_pp0_stage0_01001;
wire   [63:0] zext_ln142_fu_101_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln140_fu_117_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln140_fu_117_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln140_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln140_reg_135 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln140_fu_117_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln140_fu_117_p2 == 1'd1))) begin
...
assign add_ln142_fu_105_p2 = (zext_ln142_fu_101_p1 + in_V_offset);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln140_reg_135 == 1'd0) & (m_axi_in_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state10_io) | ((icmp_ln140_reg_135 == 1'd0) & (m_axi_in_V_RVALID == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state10_io) | ((icmp_ln140_reg_135 == 1'd0) & (m_axi_in_V_RVALID == 1'b0))));
end

always @ (*) begin
    ap_block_state10_io = ((icmp_ln140_reg_135 == 1'd0) & (out_V_V_TREADY == 1'b0));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((icmp_ln140_reg_135 == 1'd0) & (m_axi_in_V_RVALID == 1'b0));
end
...
assign i_fu_123_p2 = (i_0_reg_90 + 12'd1);

assign icmp_ln140_fu_117_p2 = ((i_0_reg_90 == 12'd3072) ? 1'b1 : 1'b0);

assign m_axi_in_V_ARADDR = in_V_addr_reg_129;
...
assign m_axi_in_V_ARLEN = 32'd3072;
...
assign zext_ln142_fu_101_p1 = in_V_offset1;
