...
#ifndef _ConvolutionInputGenerator_1_ConvolutionInputGenerator_1_HH_
#define _ConvolutionInputGenerator_1_ConvolutionInputGenerator_1_HH_
...
struct ConvolutionInputGenerator_1_ConvolutionInputGenerator_1 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    ConvolutionInputGenerator_1_ConvolutionInputGenerator_1(sc_module_name name);
    SC_HAS_PROCESS(ConvolutionInputGenerator_1_ConvolutionInputGenerator_1);
    ...
    ConvolutionInputGenerator_1_regslice_both<16>* regslice_both_in0_V_V_U;
    ConvolutionInputGenerator_1_regslice_both<16>* regslice_both_out_V_V_U;
