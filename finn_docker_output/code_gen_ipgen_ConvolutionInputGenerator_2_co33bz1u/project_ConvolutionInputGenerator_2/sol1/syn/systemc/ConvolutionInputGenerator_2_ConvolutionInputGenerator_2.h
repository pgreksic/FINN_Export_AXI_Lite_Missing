...
#ifndef _ConvolutionInputGenerator_2_ConvolutionInputGenerator_2_HH_
#define _ConvolutionInputGenerator_2_ConvolutionInputGenerator_2_HH_
...
struct ConvolutionInputGenerator_2_ConvolutionInputGenerator_2 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    ConvolutionInputGenerator_2_ConvolutionInputGenerator_2(sc_module_name name);
    SC_HAS_PROCESS(ConvolutionInputGenerator_2_ConvolutionInputGenerator_2);
    ...
    ConvolutionInputGenerator_2_regslice_both<24>* regslice_both_in0_V_V_U;
    ConvolutionInputGenerator_2_regslice_both<24>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<24> > grp_ConvolutionInputGene_1_fu_26_out_V_V_TDATA;
