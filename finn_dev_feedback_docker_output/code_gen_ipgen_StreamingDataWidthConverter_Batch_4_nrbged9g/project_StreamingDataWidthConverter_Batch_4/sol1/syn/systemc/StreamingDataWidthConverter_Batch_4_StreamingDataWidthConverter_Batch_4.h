...
#ifndef _StreamingDataWidthConverter_Batch_4_StreamingDataWidthConverter_Batch_4_HH_
#define _StreamingDataWidthConverter_Batch_4_StreamingDataWidthConverter_Batch_4_HH_
...
struct StreamingDataWidthConverter_Batch_4_StreamingDataWidthConverter_Batch_4 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    sc_in< sc_logic > ap_rst_n;
    sc_in< sc_lv<512> > in0_V_V_TDATA;
    ...
    // Module declarations
    StreamingDataWidthConverter_Batch_4_StreamingDataWidthConverter_Batch_4(sc_module_name name);
    SC_HAS_PROCESS(StreamingDataWidthConverter_Batch_4_StreamingDataWidthConverter_Batch_4);
    ...
    StreamingDataWidthConverter_Batch_4_regslice_both<512>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_4_regslice_both<16>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<512> > in0_V_V_TDATA_int;
