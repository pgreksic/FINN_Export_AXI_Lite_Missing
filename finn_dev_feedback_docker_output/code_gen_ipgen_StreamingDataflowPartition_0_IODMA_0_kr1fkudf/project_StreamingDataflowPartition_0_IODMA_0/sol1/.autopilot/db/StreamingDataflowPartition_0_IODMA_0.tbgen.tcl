set moduleName StreamingDataflowPartition_0_IODMA_0
set isTopModule 1
...
set C_modelName {StreamingDataflowPartition_0_IODMA_0}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "in0.V","cData": "uint64","bit_use": { "low": 0,"up": 63},"offset": { "type": "dynamic","port_name": "in0_V","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "numReps", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "numReps","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":28}, "offset_end" : {"in":35}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"StreamingDataflowPartition_0_IODMA_0","role":"start","value":"0","valid_bit":"0"},{"name":"StreamingDataflowPartition_0_IODMA_0","role":"continue","value":"0","valid_bit":"4"},{"name":"StreamingDataflowPartition_0_IODMA_0","role":"auto_start","value":"0","valid_bit":"7"},{"name":"in0_V","role":"data","value":"16"},{"name":"numReps","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"StreamingDataflowPartition_0_IODMA_0","role":"start","value":"0","valid_bit":"0"},{"name":"StreamingDataflowPartition_0_IODMA_0","role":"done","value":"0","valid_bit":"1"},{"name":"StreamingDataflowPartition_0_IODMA_0","role":"idle","value":"0","valid_bit":"2"},{"name":"StreamingDataflowPartition_0_IODMA_0","role":"ready","value":"0","valid_bit":"3"},{"name":"StreamingDataflowPartition_0_IODMA_0","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "6", "8", "9", "10"],
		"CDFG" : "StreamingDataflowPartition_0_IODMA_0",
		"Protocol" : "ap_ctrl_hs",
		...
		"InputProcess" : [
			{"ID" : "3", "Name" : "Mem2Stream_Batch_U0"}],
		"OutputProcess" : [
			{"ID" : "6", "Name" : "StreamingDataWidthCo_U0"}],
		"Port" : [
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "Mem2Stream_Batch_U0", "Port" : "in_V"}]},
			{"Name" : "in0_V", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_V_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "StreamingDataWidthCo_U0", "Port" : "out_V_V"}]},
			{"Name" : "numReps", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StreamingDataflowPartition_0_IODMA_0_control_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StreamingDataflowPartition_0_IODMA_0_gmem_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Mem2Stream_Batch_U0", "Parent" : "0", "Child" : ["4", "5"],
		...
		"HasNonBlockingOperation" : "0",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state3", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_Mem2Stream_fu_100"},
			{"State" : "ap_ST_fsm_state3", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_Mem2Stream_1_fu_110"}],
		"Port" : [
			{"Name" : "in_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_Mem2Stream_1_fu_110", "Port" : "in_V"},
					{"ID" : "4", "SubInstance" : "grp_Mem2Stream_fu_100", "Port" : "in_V"}]},
			{"Name" : "in_V_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "8",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_Mem2Stream_1_fu_110", "Port" : "out_V_V"},
					{"ID" : "4", "SubInstance" : "grp_Mem2Stream_fu_100", "Port" : "out_V_V"}]},
			{"Name" : "numReps", "Type" : "None", "Direction" : "I"},
			{"Name" : "numReps_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "6", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "numReps_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Mem2Stream_Batch_U0.grp_Mem2Stream_fu_100", "Parent" : "3",
		"CDFG" : "Mem2Stream",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Mem2Stream_Batch_U0.grp_Mem2Stream_1_fu_110", "Parent" : "3",
		"CDFG" : "Mem2Stream_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "out_V_V", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "out_V_V_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StreamingDataWidthCo_U0", "Parent" : "0", "Child" : ["7"],
		...
		"HasNonBlockingOperation" : "0",
		"StartSource" : "3",
		"StartFifo" : "start_for_Streamibkb_U",
		"Port" : [
			{"Name" : "in_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "8",
				"BlockSignal" : [
					{"Name" : "in_V_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out_V_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "out_V_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "numReps", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "9",
				"BlockSignal" : [
					{"Name" : "numReps_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.StreamingDataWidthCo_U0.regslice_both_out_V_V_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dwc_lcm_m_buffer_V_V_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.numReps_c_U", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Streamibkb_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	StreamingDataflowPartition_0_IODMA_0 {
