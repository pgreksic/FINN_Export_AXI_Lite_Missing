...
set portList { 
	...
	{ numReps_out_din sc_out sc_lv 32 signal 4 } 
	{ numReps_out_full_n sc_in sc_logic 1 signal 4 } 
	{ numReps_out_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "in_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_Mem2Stream_1_fu_110", "Port" : "in_V"},
					{"ID" : "1", "SubInstance" : "grp_Mem2Stream_fu_100", "Port" : "in_V"}]},
			{"Name" : "in_V_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_Mem2Stream_1_fu_110", "Port" : "out_V_V"},
					{"ID" : "1", "SubInstance" : "grp_Mem2Stream_fu_100", "Port" : "out_V_V"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_fu_100", "Parent" : "0",
		"CDFG" : "Mem2Stream",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_1_fu_110", "Parent" : "0",
		"CDFG" : "Mem2Stream_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
