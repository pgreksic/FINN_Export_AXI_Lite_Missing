...
#include "StreamingDataflowPartition_0_IODMA_0_fifo_w64_d2_A.h"
#include "StreamingDataflowPartition_0_IODMA_0_fifo_w32_d2_A.h"
#include "StreamingDataflowPartition_0_IODMA_0_start_for_Streamibkb.h"
...
struct StreamingDataflowPartition_0_IODMA_0_StreamingDataflowPartition_0_IODMA_0 : public sc_module {
    ...
    StreamingDataflowPartition_0_IODMA_0_StreamingDataflowPartition_0_IODMA_0_gmem_m_axi<0,64,64,5,16,16,16,16,C_M_AXI_GMEM_ID_WIDTH,C_M_AXI_GMEM_ADDR_WIDTH,C_M_AXI_GMEM_DATA_WIDTH,C_M_AXI_GMEM_AWUSER_WIDTH,C_M_AXI_GMEM_ARUSER_WIDTH,C_M_AXI_GMEM_WUSER_WIDTH,C_M_AXI_GMEM_RUSER_WIDTH,C_M_AXI_GMEM_BUSER_WIDTH,C_M_AXI_GMEM_USER_VALUE,C_M_AXI_GMEM_PROT_VALUE,C_M_AXI_GMEM_CACHE_VALUE>* StreamingDataflowPartition_0_IODMA_0_gmem_m_axi_U;
    StreamingDataflowPartition_0_IODMA_0_Mem2Stream_Batch* Mem2Stream_Batch_U0;
    StreamingDataflowPartition_0_IODMA_0_StreamingDataWidthCo* StreamingDataWidthCo_U0;
    StreamingDataflowPartition_0_IODMA_0_fifo_w64_d2_A* dwc_lcm_m_buffer_V_V_U;
    StreamingDataflowPartition_0_IODMA_0_fifo_w32_d2_A* numReps_c_U;
    StreamingDataflowPartition_0_IODMA_0_start_for_Streamibkb* start_for_Streamibkb_U;
    ...
    sc_signal< sc_lv<64> > Mem2Stream_Batch_U0_out_V_V_din;
    sc_signal< sc_logic > Mem2Stream_Batch_U0_out_V_V_write;
    sc_signal< sc_lv<32> > Mem2Stream_Batch_U0_numReps_out_din;
    sc_signal< sc_logic > Mem2Stream_Batch_U0_numReps_out_write;
    ...
    sc_signal< sc_lv<8> > StreamingDataWidthCo_U0_out_V_V_TDATA;
    sc_signal< sc_logic > StreamingDataWidthCo_U0_out_V_V_TVALID;
    sc_signal< sc_logic > StreamingDataWidthCo_U0_numReps_read;
    sc_signal< sc_logic > ap_sync_continue;
    sc_signal< sc_logic > dwc_lcm_m_buffer_V_V_full_n;
    sc_signal< sc_lv<64> > dwc_lcm_m_buffer_V_V_dout;
    sc_signal< sc_logic > dwc_lcm_m_buffer_V_V_empty_n;
