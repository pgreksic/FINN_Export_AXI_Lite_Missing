...
struct StreamingDataWidthConverter_Batch_2_StreamingDataWidthConverter_Batch_2 : public sc_module {
    ...
    StreamingDataWidthConverter_Batch_2_regslice_both<8>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_2_regslice_both<16>* regslice_both_out_V_V_U;
