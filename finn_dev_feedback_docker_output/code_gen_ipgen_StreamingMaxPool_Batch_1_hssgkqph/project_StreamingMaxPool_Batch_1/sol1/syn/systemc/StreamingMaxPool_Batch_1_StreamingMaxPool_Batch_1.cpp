...
#include "StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1.h"
#include "AESL_pkg.h"
...
const sc_logic StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<4> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_ST_fsm_state1 = "1";
const sc_lv<4> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_ST_fsm_state2 = "10";
const sc_lv<4> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_ST_fsm_state3 = "100";
const sc_lv<4> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_ST_fsm_state4 = "1000";
const sc_lv<32> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv32_1 = "1";
const sc_lv<2> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv2_0 = "00";
const sc_lv<32> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<32> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv32_2 = "10";
const sc_lv<1> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv1_0 = "0";
const sc_lv<2> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv2_2 = "10";
const sc_lv<2> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv2_1 = "1";
const sc_lv<1> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv1_1 = "1";
const sc_lv<32> StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_lv32_3 = "11";
const bool StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::ap_const_boolean_1 = true;

StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_StreamingMaxPool_Pre_fu_47 = new StreamingMaxPool_Batch_1_StreamingMaxPool_Pre("grp_StreamingMaxPool_Pre_fu_47");
    ...
    regslice_both_in0_V_V_U = new StreamingMaxPool_Batch_1_regslice_both<512>("regslice_both_in0_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingMaxPool_Batch_1_regslice_both<512>("regslice_both_out_V_V_U");
    ...
    apTFilenSS << "StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1.hdltvin.dat");
    mHdltvoutHandle.open("StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1.hdltvout.dat");
}

StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::~StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1() {
    if (mVcdFile) 
...
void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_clk_no_reset_() {
...
void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_CS_fsm_state4() {
    ap_CS_fsm_state4 = ap_CS_fsm.read()[3];
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_grp_StreamingMaxPool_Pre_fu_47_ap_start() {
    grp_StreamingMaxPool_Pre_fu_47_ap_start = grp_StreamingMaxPool_Pre_fu_47_ap_start_reg.read();
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_grp_StreamingMaxPool_Pre_fu_47_out_V_V_TREADY() {
    grp_StreamingMaxPool_Pre_fu_47_out_V_V_TREADY = (ap_CS_fsm_state3.read() & out_V_V_TREADY_int.read());
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_icmp_ln212_fu_55_p2() {
    icmp_ln212_fu_55_p2 = (!rep_0_i_reg_36.read().is_01() || !ap_const_lv2_2.is_01())? sc_lv<1>(): sc_lv<1>(rep_0_i_reg_36.read() == ap_const_lv2_2);
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_in0_V_V_TREADY() {
...
void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_in0_V_V_TREADY_int() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_out_V_V_TVALID() {
    out_V_V_TVALID = regslice_both_out_V_V_U_vld_out.read();
}

void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_rep_fu_61_p2() {
...
void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_ap_NS_fsm() {
...
void StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1::thread_hdltv_gen() {
