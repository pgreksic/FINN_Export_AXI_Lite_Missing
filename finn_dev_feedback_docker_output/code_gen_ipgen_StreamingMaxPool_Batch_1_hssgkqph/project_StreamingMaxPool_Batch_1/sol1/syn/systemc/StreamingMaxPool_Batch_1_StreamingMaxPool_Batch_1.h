...
#ifndef _StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1_HH_
#define _StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1_HH_
...
struct StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1(sc_module_name name);
    SC_HAS_PROCESS(StreamingMaxPool_Batch_1_StreamingMaxPool_Batch_1);
    ...
    StreamingMaxPool_Batch_1_regslice_both<512>* regslice_both_in0_V_V_U;
    StreamingMaxPool_Batch_1_regslice_both<512>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<512> > grp_StreamingMaxPool_Pre_fu_47_out_V_V_TDATA;
