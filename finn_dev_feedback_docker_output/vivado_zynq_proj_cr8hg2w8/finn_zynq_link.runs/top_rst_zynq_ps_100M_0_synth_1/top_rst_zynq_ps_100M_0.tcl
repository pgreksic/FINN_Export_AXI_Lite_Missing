...
namespace eval ::optrace {
  variable script "/workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1/top_rst_zynq_ps_100M_0.tcl"
...
read_ip -quiet /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1 -new_name top_rst_zynq_ps_100M_0 -ip [get_ips top_rst_zynq_ps_100M_0]]
...
synth_design -top top_rst_zynq_ps_100M_0 -part xc7z020clg400-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp top_rst_zynq_ps_100M_0.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips top_rst_zynq_ps_100M_0]
 }
...
if { [catch {
  file copy -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1/top_rst_zynq_ps_100M_0.dcp /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1/top_rst_zynq_ps_100M_0_stub.v /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1/top_rst_zynq_ps_100M_0_stub.vhdl /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1/top_rst_zynq_ps_100M_0_sim_netlist.v /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.runs/top_rst_zynq_ps_100M_0_synth_1/top_rst_zynq_ps_100M_0_sim_netlist.vhdl /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.ip_user_files/ip/top_rst_zynq_ps_100M_0]} {
  catch { 
    file copy -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_stub.v /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.ip_user_files/ip/top_rst_zynq_ps_100M_0
  }
}

if {[file isdir /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.ip_user_files/ip/top_rst_zynq_ps_100M_0]} {
  catch { 
    file copy -force /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.srcs/sources_1/bd/top/ip/top_rst_zynq_ps_100M_0/top_rst_zynq_ps_100M_0_stub.vhdl /workspace/Diplomski_rad/finn_modified_docker_output_dir/vivado_zynq_proj_cr8hg2w8/finn_zynq_link.ip_user_files/ip/top_rst_zynq_ps_100M_0
  }
}
