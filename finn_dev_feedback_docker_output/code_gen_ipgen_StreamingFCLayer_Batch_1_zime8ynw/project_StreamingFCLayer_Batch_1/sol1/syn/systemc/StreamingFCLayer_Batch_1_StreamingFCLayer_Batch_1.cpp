...
StreamingFCLayer_Batch_1_StreamingFCLayer_Batch_1::StreamingFCLayer_Batch_1_StreamingFCLayer_Batch_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Matrix_Vector_Activa_fu_84 = new StreamingFCLayer_Batch_1_Matrix_Vector_Activa("grp_Matrix_Vector_Activa_fu_84");
    ...
    regslice_both_in0_V_V_U = new StreamingFCLayer_Batch_1_regslice_both<8>("regslice_both_in0_V_V_U");
    ...
    regslice_both_weights_V_V_U = new StreamingFCLayer_Batch_1_regslice_both<16>("regslice_both_weights_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingFCLayer_Batch_1_regslice_both<8>("regslice_both_out_V_V_U");
...
void StreamingFCLayer_Batch_1_StreamingFCLayer_Batch_1::thread_grp_Matrix_Vector_Activa_fu_84_ap_start() {
    grp_Matrix_Vector_Activa_fu_84_ap_start = grp_Matrix_Vector_Activa_fu_84_ap_start_reg.read();
}

void StreamingFCLayer_Batch_1_StreamingFCLayer_Batch_1::thread_grp_Matrix_Vector_Activa_fu_84_out_V_V_TREADY() {
