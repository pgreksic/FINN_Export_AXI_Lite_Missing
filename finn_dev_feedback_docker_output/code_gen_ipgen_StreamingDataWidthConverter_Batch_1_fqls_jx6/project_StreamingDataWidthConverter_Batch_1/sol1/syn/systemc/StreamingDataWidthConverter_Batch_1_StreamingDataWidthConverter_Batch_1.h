...
struct StreamingDataWidthConverter_Batch_1_StreamingDataWidthConverter_Batch_1 : public sc_module {
    ...
    StreamingDataWidthConverter_Batch_1_regslice_both<256>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_1_regslice_both<8>* regslice_both_out_V_V_U;
