...
const sc_lv<504> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv504_lc_1 = "";
const sc_lv<13> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv13_0 = "0000000000000";
const sc_lv<13> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv13_1900 = "1100100000000";
const sc_lv<13> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv13_1 = "1";
const sc_lv<32> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv32_40 = "1000000";
const sc_lv<32> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv32_8 = "1000";
const sc_lv<32> StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::ap_const_lv32_1F7 = "111110111";
...
void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        r_V_reg_69 = trunc_ln_fu_146_p3.read();
                ...
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        r_V_reg_69 = ap_const_lv504_lc_1;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         esl_seteq<1,1,1>(icmp_ln508_fu_96_p2.read(), ap_const_lv1_0) && 
...
void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_i_fu_119_p2() {
...
void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_icmp_ln508_fu_96_p2() {
    icmp_ln508_fu_96_p2 = (!t_0_reg_80.read().is_01() || !ap_const_lv13_1900.is_01())? sc_lv<1>(): sc_lv<1>(t_0_reg_80.read() == ap_const_lv13_1900);
}

void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_icmp_ln517_fu_125_p2() {
    icmp_ln517_fu_125_p2 = (!i_fu_119_p2.read().is_01() || !ap_const_lv32_40.is_01())? sc_lv<1>(): sc_lv<1>(i_fu_119_p2.read() == ap_const_lv32_40);
}
...
void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_p_Result_s_fu_111_p3() {
    p_Result_s_fu_111_p3 = esl_concat<8,504>(in_V_V_TDATA.read(), r_V_reg_69.read());
}

void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_t_fu_102_p2() {
    t_fu_102_p2 = (!t_0_reg_80.read().is_01() || !ap_const_lv13_1.is_01())? sc_lv<13>(): (sc_biguint<13>(t_0_reg_80.read()) + sc_biguint<13>(ap_const_lv13_1));
}

void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_tmp_1_fu_136_p4() {
    tmp_1_fu_136_p4 = r_V_reg_69.read().range(503, 8);
}

void StreamingDataWidthConverter_Batch_3_StreamingDataWidthCo_1::thread_trunc_ln_fu_146_p3() {
    trunc_ln_fu_146_p3 = esl_concat<8,496>(in_V_V_TDATA.read(), tmp_1_fu_136_p4.read());
}
