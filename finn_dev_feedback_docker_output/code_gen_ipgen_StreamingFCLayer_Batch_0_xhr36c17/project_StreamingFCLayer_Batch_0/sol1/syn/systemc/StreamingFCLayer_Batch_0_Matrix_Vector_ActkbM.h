...
// ==============================================================
#ifndef __StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM_H__
#define __StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM_H__
...
struct StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM_ram : public sc_core::sc_module {
...
SC_MODULE(StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM) {
...
StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM_ram* meminst;


SC_CTOR(StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM) {
meminst = new StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM_ram("StreamingFCLayer_Batch_0_Matrix_Vector_ActkbM_ram");
