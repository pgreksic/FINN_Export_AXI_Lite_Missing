...
// ==============================================================
#ifndef __StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi_H__
#define __StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi_H__
...
struct StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi_ram : public sc_core::sc_module {
...
SC_MODULE(StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi) {
...
StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi_ram* meminst;


SC_CTOR(StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi) {
meminst = new StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi_ram("StreamingFCLayer_Batch_0_Matrix_Vector_ActfYi_ram");
