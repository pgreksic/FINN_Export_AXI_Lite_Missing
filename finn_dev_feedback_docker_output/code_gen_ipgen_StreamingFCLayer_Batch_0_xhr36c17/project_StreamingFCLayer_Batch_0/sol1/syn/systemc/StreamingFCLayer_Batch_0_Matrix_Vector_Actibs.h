...
// ==============================================================
#ifndef __StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_H__
#define __StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_H__
...
struct StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_ram) {
        ram[0] = "0b0101111010000001";
        ram[1] = "0b1010000110000000";
        ram[2] = "0b1010010000101100";
        ram[3] = "0b0101111010000001";
        ram[4] = "0b1100001101111111";
...
SC_MODULE(StreamingFCLayer_Batch_0_Matrix_Vector_Actibs) {
...
StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_ram* meminst;


SC_CTOR(StreamingFCLayer_Batch_0_Matrix_Vector_Actibs) {
meminst = new StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_ram("StreamingFCLayer_Batch_0_Matrix_Vector_Actibs_ram");
