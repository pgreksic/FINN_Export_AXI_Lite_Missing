...
#ifndef _ConvolutionInputGenerator_4_ConvolutionInputGenerator_4_HH_
#define _ConvolutionInputGenerator_4_ConvolutionInputGenerator_4_HH_
...
struct ConvolutionInputGenerator_4_ConvolutionInputGenerator_4 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    ConvolutionInputGenerator_4_ConvolutionInputGenerator_4(sc_module_name name);
    SC_HAS_PROCESS(ConvolutionInputGenerator_4_ConvolutionInputGenerator_4);
    ...
    ConvolutionInputGenerator_4_ConvolutionInputGene_1* grp_ConvolutionInputGene_1_fu_26;
    ConvolutionInputGenerator_4_regslice_both<16>* regslice_both_in0_V_V_U;
    ConvolutionInputGenerator_4_regslice_both<16>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<16> > grp_ConvolutionInputGene_1_fu_26_out_V_V_TDATA;
