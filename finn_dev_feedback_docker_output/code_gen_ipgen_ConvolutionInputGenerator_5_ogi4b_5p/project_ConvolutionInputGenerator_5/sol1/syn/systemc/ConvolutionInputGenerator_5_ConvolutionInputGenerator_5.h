...
#ifndef _ConvolutionInputGenerator_5_ConvolutionInputGenerator_5_HH_
#define _ConvolutionInputGenerator_5_ConvolutionInputGenerator_5_HH_
...
struct ConvolutionInputGenerator_5_ConvolutionInputGenerator_5 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    ConvolutionInputGenerator_5_ConvolutionInputGenerator_5(sc_module_name name);
    SC_HAS_PROCESS(ConvolutionInputGenerator_5_ConvolutionInputGenerator_5);

    ~ConvolutionInputGenerator_5_ConvolutionInputGenerator_5();

    sc_trace_file* mVcdFile;

    ofstream mHdltvinHandle;
    ofstream mHdltvoutHandle;
    ConvolutionInputGenerator_5_ConvolutionInputGene_1* grp_ConvolutionInputGene_1_fu_26;
    ConvolutionInputGenerator_5_regslice_both<16>* regslice_both_in0_V_V_U;
    ConvolutionInputGenerator_5_regslice_both<16>* regslice_both_out_V_V_U;
