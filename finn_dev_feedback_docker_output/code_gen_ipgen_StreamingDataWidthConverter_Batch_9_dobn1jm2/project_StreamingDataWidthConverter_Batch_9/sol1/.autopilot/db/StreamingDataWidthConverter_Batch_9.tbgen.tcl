set moduleName StreamingDataWidthConverter_Batch_9
set isTopModule 1
...
set C_modelName {StreamingDataWidthConverter_Batch_9}
set C_modelType { void 0 }
set C_modelArgList {
	{ in0_V_V int 112 regular {axi_s 0 volatile  { in0_V_V Data } }  }
	{ out_V_V int 16 regular {axi_s 1 volatile  { out_V_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V_V", "interface" : "axis", "bitwidth" : 112, "direction" : "READONLY", "bitSlice":[{"low":0,"up":111,"cElement": [{"cName": "in0.V.V","cData": "uint112","bit_use": { "low": 0,"up": 111},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ in0_V_V_TDATA sc_in sc_lv 112 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in0_V_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":112, "type": "signal", "bundle":{"name": "in0_V_V", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "StreamingDataWidthConverter_Batch_9",
...
set Spec2ImplPortList { 
	in0_V_V { axis {  { in0_V_V_TDATA in_data 0 112 }  { in0_V_V_TVALID in_vld 0 1 }  { in0_V_V_TREADY in_acc 1 1 } } }
