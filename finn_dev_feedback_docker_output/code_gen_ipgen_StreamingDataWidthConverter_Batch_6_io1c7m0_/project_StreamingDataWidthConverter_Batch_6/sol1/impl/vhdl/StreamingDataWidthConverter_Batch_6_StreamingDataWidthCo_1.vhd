...
entity StreamingDataWidthConverter_Batch_6_StreamingDataWidthCo_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of StreamingDataWidthConverter_Batch_6_StreamingDataWidthCo_1 is 
    ...
    signal t_0_reg_72 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    icmp_ln508_fu_88_p2 <= "1" when (t_0_reg_72 = ap_const_lv9_100) else "0";
    ...
    t_fu_94_p2 <= std_logic_vector(unsigned(t_0_reg_72) + unsigned(ap_const_lv9_1));
