...
entity StreamingDataWidthConverter_Batch_6_StreamingDataWidthConverter_Batch_6 is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of StreamingDataWidthConverter_Batch_6_StreamingDataWidthConverter_Batch_6 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "StreamingDataWidthConverter_Batch_6_StreamingDataWidthConverter_Batch_6,hls_ip_2020_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.025000,HLS_SYN_LAT=261,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=69,HLS_SYN_LUT=225,HLS_VERSION=2020_1_1}";
    ...
    component StreamingDataWidthConverter_Batch_6_StreamingDataWidthCo_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_StreamingDataWidthCo_1_fu_26 : component StreamingDataWidthConverter_Batch_6_StreamingDataWidthCo_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
