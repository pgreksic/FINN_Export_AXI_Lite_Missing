...
entity ConvolutionInputGenerator_4_ConvolutionInputGenerator_4 is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of ConvolutionInputGenerator_4_ConvolutionInputGenerator_4 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "ConvolutionInputGenerator_4_ConvolutionInputGenerator_4,hls_ip_2020_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.819750,HLS_SYN_LAT=3077,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=474,HLS_SYN_LUT=1532,HLS_VERSION=2020_1_1}";
    ...
    signal grp_ConvolutionInputGene_1_fu_26_out_V_V_TDATA : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component ConvolutionInputGenerator_4_ConvolutionInputGene_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_ConvolutionInputGene_1_fu_26 : component ConvolutionInputGenerator_4_ConvolutionInputGene_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
