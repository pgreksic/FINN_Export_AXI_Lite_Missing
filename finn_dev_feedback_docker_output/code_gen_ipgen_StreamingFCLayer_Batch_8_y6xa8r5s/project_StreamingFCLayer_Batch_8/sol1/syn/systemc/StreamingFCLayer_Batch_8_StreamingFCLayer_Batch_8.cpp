...
#include "StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8.h"
#include "AESL_pkg.h"
...
const sc_logic StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<4> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_ST_fsm_state1 = "1";
const sc_lv<4> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_ST_fsm_state2 = "10";
const sc_lv<4> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_ST_fsm_state3 = "100";
const sc_lv<4> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_ST_fsm_state4 = "1000";
const sc_lv<32> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_const_lv32_1 = "1";
const sc_lv<32> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_const_lv32_2 = "10";
const sc_lv<32> StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_const_lv32_3 = "11";
const bool StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::ap_const_boolean_1 = true;

StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Matrix_Vector_Activa_fu_28 = new StreamingFCLayer_Batch_8_Matrix_Vector_Activa("grp_Matrix_Vector_Activa_fu_28");
    ...
    grp_Matrix_Vector_Activa_fu_28->in_V_V_TDATA(in0_V_V_TDATA_int);
    grp_Matrix_Vector_Activa_fu_28->in_V_V_TVALID(in0_V_V_TVALID_int);
    ...
    grp_Matrix_Vector_Activa_fu_28->weight_V_V_TDATA(weights_V_V_TDATA_int);
    grp_Matrix_Vector_Activa_fu_28->weight_V_V_TVALID(weights_V_V_TVALID_int);
    grp_Matrix_Vector_Activa_fu_28->weight_V_V_TREADY(grp_Matrix_Vector_Activa_fu_28_weight_V_V_TREADY);
    regslice_both_in0_V_V_U = new StreamingFCLayer_Batch_8_regslice_both<8>("regslice_both_in0_V_V_U");
    ...
    regslice_both_weights_V_V_U = new StreamingFCLayer_Batch_8_regslice_both<32>("regslice_both_weights_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingFCLayer_Batch_8_regslice_both<112>("regslice_both_out_V_V_U");
    regslice_both_out_V_V_U->ap_clk(ap_clk);
    regslice_both_out_V_V_U->ap_rst(ap_rst_n_inv);
    regslice_both_out_V_V_U->data_in(grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA);
    regslice_both_out_V_V_U->vld_in(grp_Matrix_Vector_Activa_fu_28_out_V_V_TVALID);
    ...
    apTFilenSS << "StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8.hdltvin.dat");
    mHdltvoutHandle.open("StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8.hdltvout.dat");
}

StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::~StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8() {
    if (mVcdFile) 
...
void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_ap_clk_no_reset_() {
...
void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_ap_CS_fsm_state4() {
    ap_CS_fsm_state4 = ap_CS_fsm.read()[3];
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_grp_Matrix_Vector_Activa_fu_28_ap_start() {
    grp_Matrix_Vector_Activa_fu_28_ap_start = grp_Matrix_Vector_Activa_fu_28_ap_start_reg.read();
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY() {
    grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY = (ap_CS_fsm_state3.read() & out_V_V_TREADY_int.read());
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_in0_V_V_TREADY() {
...
void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_in0_V_V_TREADY_int() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        in0_V_V_TREADY_int = grp_Matrix_Vector_Activa_fu_28_in_V_V_TREADY.read();
    } else {
        in0_V_V_TREADY_int = ap_const_logic_0;
    }
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_out_V_V_TVALID() {
    out_V_V_TVALID = regslice_both_out_V_V_U_vld_out.read();
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_weights_V_V_TREADY() {
...
void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_weights_V_V_TREADY_int() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        weights_V_V_TREADY_int = grp_Matrix_Vector_Activa_fu_28_weight_V_V_TREADY.read();
    } else {
        weights_V_V_TREADY_int = ap_const_logic_0;
    }
}

void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_ap_NS_fsm() {
...
void StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8::thread_hdltv_gen() {
