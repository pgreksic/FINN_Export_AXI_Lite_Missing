...
entity StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5 is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5 is 
    ...
    component StreamingDataWidthConverter_Batch_5_StreamingDataWidthCo_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_StreamingDataWidthCo_1_fu_26 : component StreamingDataWidthConverter_Batch_5_StreamingDataWidthCo_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
