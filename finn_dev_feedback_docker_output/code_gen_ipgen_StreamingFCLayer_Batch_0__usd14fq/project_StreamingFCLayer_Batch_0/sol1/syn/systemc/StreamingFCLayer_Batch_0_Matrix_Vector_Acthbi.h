...
// ==============================================================
#ifndef __StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi_H__
#define __StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi_H__
...
struct StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi_ram : public sc_core::sc_module {
...
SC_MODULE(StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi) {
...
StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi_ram* meminst;


SC_CTOR(StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi) {
meminst = new StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi_ram("StreamingFCLayer_Batch_0_Matrix_Vector_Acthbi_ram");
