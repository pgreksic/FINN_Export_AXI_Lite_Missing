...
#include "StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5.h"
#include "AESL_pkg.h"
...
const sc_logic StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<4> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_ST_fsm_state1 = "1";
const sc_lv<4> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_ST_fsm_state2 = "10";
const sc_lv<4> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_ST_fsm_state3 = "100";
const sc_lv<4> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_ST_fsm_state4 = "1000";
const sc_lv<32> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_const_lv32_1 = "1";
const sc_lv<32> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_const_lv32_2 = "10";
const sc_lv<32> StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_const_lv32_3 = "11";
const bool StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::ap_const_boolean_1 = true;

StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_StreamingDataWidthCo_1_fu_26 = new StreamingDataWidthConverter_Batch_5_StreamingDataWidthCo_1("grp_StreamingDataWidthCo_1_fu_26");
    ...
    regslice_both_in0_V_V_U = new StreamingDataWidthConverter_Batch_5_regslice_both<8>("regslice_both_in0_V_V_U");
    ...
    regslice_both_out_V_V_U = new StreamingDataWidthConverter_Batch_5_regslice_both<16>("regslice_both_out_V_V_U");
    ...
    apTFilenSS << "StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5.hdltvin.dat");
    mHdltvoutHandle.open("StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5.hdltvout.dat");
}

StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::~StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5() {
    if (mVcdFile) 
...
void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_ap_clk_no_reset_() {
...
void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_ap_CS_fsm_state4() {
    ap_CS_fsm_state4 = ap_CS_fsm.read()[3];
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_grp_StreamingDataWidthCo_1_fu_26_ap_start() {
    grp_StreamingDataWidthCo_1_fu_26_ap_start = grp_StreamingDataWidthCo_1_fu_26_ap_start_reg.read();
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_grp_StreamingDataWidthCo_1_fu_26_out_V_V_TREADY() {
    grp_StreamingDataWidthCo_1_fu_26_out_V_V_TREADY = (ap_CS_fsm_state3.read() & out_V_V_TREADY_int.read());
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_in0_V_V_TREADY() {
...
void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_in0_V_V_TREADY_int() {
...
void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_out_V_V_TVALID() {
    out_V_V_TVALID = regslice_both_out_V_V_U_vld_out.read();
}

void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_ap_NS_fsm() {
...
void StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5::thread_hdltv_gen() {
