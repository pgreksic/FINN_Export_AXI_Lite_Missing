...
#ifndef _StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5_HH_
#define _StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5_HH_
...
struct StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5(sc_module_name name);
    SC_HAS_PROCESS(StreamingDataWidthConverter_Batch_5_StreamingDataWidthConverter_Batch_5);
    ...
    StreamingDataWidthConverter_Batch_5_regslice_both<8>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_5_regslice_both<16>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<16> > grp_StreamingDataWidthCo_1_fu_26_out_V_V_TDATA;
