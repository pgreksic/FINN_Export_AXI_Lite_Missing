set moduleName StreamingFCLayer_Batch_8
set isTopModule 1
...
set C_modelName {StreamingFCLayer_Batch_8}
set C_modelType { void 0 }
set C_modelArgList {
	{ in0_V_V int 8 regular {axi_s 0 volatile  { in0_V_V Data } }  }
	{ weights_V_V int 32 regular {axi_s 0 volatile  { weights_V_V Data } }  }
	{ out_V_V int 112 regular {axi_s 1 volatile  { out_V_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":3,"cElement": [{"cName": "in0.V.V","cData": "uint4","bit_use": { "low": 0,"up": 3},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "weights_V_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":27,"cElement": [{"cName": "weights.V.V","cData": "uint28","bit_use": { "low": 0,"up": 27},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "out_V_V", "interface" : "axis", "bitwidth" : 112, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":111,"cElement": [{"cName": "out.V.V","cData": "uint112","bit_use": { "low": 0,"up": 111},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ out_V_V_TDATA sc_out sc_lv 112 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_V_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":112, "type": "signal", "bundle":{"name": "out_V_V", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Matrix_Vector_Activa_fu_28", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7", "8", "9"],
	...
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_in0_V_V_U", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_weights_V_V_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_V_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	out_V_V { axis {  { out_V_V_TDATA out_data 1 112 }  { out_V_V_TVALID out_vld 1 1 }  { out_V_V_TREADY out_acc 0 1 } } }
}
