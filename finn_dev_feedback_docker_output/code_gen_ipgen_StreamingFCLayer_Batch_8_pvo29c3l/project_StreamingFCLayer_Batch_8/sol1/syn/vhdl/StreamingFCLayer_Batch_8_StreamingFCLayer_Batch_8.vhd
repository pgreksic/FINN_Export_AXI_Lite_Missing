...
entity StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8 is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8,hls_ip_2020_1_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.421000,HLS_SYN_LAT=517,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2278,HLS_SYN_LUT=3491,HLS_VERSION=2020_1_1}";
    ...
    signal grp_Matrix_Vector_Activa_fu_28_ap_start : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_ap_done : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_ap_idle : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_ap_ready : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_in_V_V_TREADY : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA : STD_LOGIC_VECTOR (111 downto 0);
    signal grp_Matrix_Vector_Activa_fu_28_out_V_V_TVALID : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_weight_V_V_TREADY : STD_LOGIC;
    signal grp_Matrix_Vector_Activa_fu_28_ap_start_reg : STD_LOGIC := '0';
    ...
    component StreamingFCLayer_Batch_8_Matrix_Vector_Activa IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    grp_Matrix_Vector_Activa_fu_28 : component StreamingFCLayer_Batch_8_Matrix_Vector_Activa
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_Matrix_Vector_Activa_fu_28_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((grp_Matrix_Vector_Activa_fu_28_ap_ready = ap_const_logic_1)) then 
                    grp_Matrix_Vector_Activa_fu_28_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (grp_Matrix_Vector_Activa_fu_28_ap_done, ap_CS_fsm, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_out_V_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_Matrix_Vector_Activa_fu_28_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    grp_Matrix_Vector_Activa_fu_28_ap_start <= grp_Matrix_Vector_Activa_fu_28_ap_start_reg;
    grp_Matrix_Vector_Activa_fu_28_out_V_V_TREADY <= (out_V_V_TREADY_int and ap_CS_fsm_state3);
    ...
    in0_V_V_TREADY_int_assign_proc : process(grp_Matrix_Vector_Activa_fu_28_in_V_V_TREADY, ap_CS_fsm_state3)
    begin
    ...
    weights_V_V_TREADY_int_assign_proc : process(grp_Matrix_Vector_Activa_fu_28_weight_V_V_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
