...
#ifndef _StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8_HH_
#define _StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8_HH_
...
struct StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8 : public sc_module {
    ...
    // Module declarations
    StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8(sc_module_name name);
    SC_HAS_PROCESS(StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8);

    ~StreamingFCLayer_Batch_8_StreamingFCLayer_Batch_8();

    sc_trace_file* mVcdFile;

    ofstream mHdltvinHandle;
    ofstream mHdltvoutHandle;
    StreamingFCLayer_Batch_8_Matrix_Vector_Activa* grp_Matrix_Vector_Activa_fu_28;
    StreamingFCLayer_Batch_8_regslice_both<8>* regslice_both_in0_V_V_U;
    StreamingFCLayer_Batch_8_regslice_both<32>* regslice_both_weights_V_V_U;
    StreamingFCLayer_Batch_8_regslice_both<112>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<112> > grp_Matrix_Vector_Activa_fu_28_out_V_V_TDATA;
