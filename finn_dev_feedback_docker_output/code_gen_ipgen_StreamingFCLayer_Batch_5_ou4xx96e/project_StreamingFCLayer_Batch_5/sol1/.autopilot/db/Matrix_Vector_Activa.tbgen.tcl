...
set C_modelArgList {
	...
	{ weight_V_V int 16 regular {axi_s 0 volatile  { weight_V_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "out_V_V", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "weight_V_V", "interface" : "axis", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ weight_V_V_TDATA sc_in sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weight_V_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "weight_V_V", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StreamingFCLayer_qcK_U4", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StreamingFCLayer_qcK_U5", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "147460", "Max" : "147460"}
	, {"Name" : "Interval", "Min" : "147460", "Max" : "147460"}
]}
...
set Spec2ImplPortList { 
	...
	weight_V_V { axis {  { weight_V_V_TDATA in_data 0 16 }  { weight_V_V_TVALID in_vld 0 1 }  { weight_V_V_TREADY in_acc 1 1 } } }
}
