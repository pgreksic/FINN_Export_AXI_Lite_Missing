...
#ifndef _StreamingDataWidthConverter_Batch_9_StreamingDataWidthConverter_Batch_9_HH_
#define _StreamingDataWidthConverter_Batch_9_StreamingDataWidthConverter_Batch_9_HH_
...
struct StreamingDataWidthConverter_Batch_9_StreamingDataWidthConverter_Batch_9 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    sc_in< sc_logic > ap_rst_n;
    sc_in< sc_lv<112> > in0_V_V_TDATA;
    ...
    // Module declarations
    StreamingDataWidthConverter_Batch_9_StreamingDataWidthConverter_Batch_9(sc_module_name name);
    SC_HAS_PROCESS(StreamingDataWidthConverter_Batch_9_StreamingDataWidthConverter_Batch_9);
    ...
    StreamingDataWidthConverter_Batch_9_regslice_both<112>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_9_regslice_both<16>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<112> > in0_V_V_TDATA_int;
