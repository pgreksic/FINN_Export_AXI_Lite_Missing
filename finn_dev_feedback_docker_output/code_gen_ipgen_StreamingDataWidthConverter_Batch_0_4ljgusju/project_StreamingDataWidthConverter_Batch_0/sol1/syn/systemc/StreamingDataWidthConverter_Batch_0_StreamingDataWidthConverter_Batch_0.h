...
#ifndef _StreamingDataWidthConverter_Batch_0_StreamingDataWidthConverter_Batch_0_HH_
#define _StreamingDataWidthConverter_Batch_0_StreamingDataWidthConverter_Batch_0_HH_
...
struct StreamingDataWidthConverter_Batch_0_StreamingDataWidthConverter_Batch_0 : public sc_module {
    // Port declarations 8
    sc_in_clk ap_clk;
    ...
    // Module declarations
    StreamingDataWidthConverter_Batch_0_StreamingDataWidthConverter_Batch_0(sc_module_name name);
    SC_HAS_PROCESS(StreamingDataWidthConverter_Batch_0_StreamingDataWidthConverter_Batch_0);
    ...
    StreamingDataWidthConverter_Batch_0_regslice_both<8>* regslice_both_in0_V_V_U;
    StreamingDataWidthConverter_Batch_0_regslice_both<256>* regslice_both_out_V_V_U;
    ...
    sc_signal< sc_lv<256> > grp_StreamingDataWidthCo_1_fu_26_out_V_V_TDATA;
